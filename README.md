...
4. Name the Lambda Function "Cat-Geek-Example-Skill".
...
2. Set "CatFacts" as the skill name and "cat facts" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, Ask cat facts for a cat fact."
